...
call s:HL('DiffAdd',                        s:green,    s:gray1,    'none')
call s:HL('DiffChange',                     s:yellow,   s:gray1,    'none')
call s:HL('DiffDelete',                     s:red,      s:gray1,    'none')
...
call s:HL('PmenuSel',                       s:gray1,    s:cyan,     '')
...
call s:HL('SpellCap',                       s:blue,     s:gray1,    'undercurl')
call s:HL('SpellBad',                       s:red,      s:gray1,    'undercurl')
...
call s:HL('WildMenu',                       s:gray1,    s:cyan,	    '')
