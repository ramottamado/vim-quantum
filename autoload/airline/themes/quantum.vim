...
function! airline#themes#quantum#refresh()
    ...
    let s:R1 = airline#themes#get_highlight2(['Normal', 'bg'], ['Error', 'fg'], 'bold')
    ...
    let s:V1 = airline#themes#get_highlight2(['Normal', 'bg'], ['Statement', 'fg'], 'bold')
    ...
    if get(g:, 'loaded_ctrlp', 0)
        let g:airline#themes#quantum#palette.ctrlp = airline#extensions#ctrlp#generate_color_map(
                \ airline#themes#get_highlight('Normal'),
